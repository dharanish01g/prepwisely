    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "flex items-center gap-1 rounded-(--radius-md) text-sm [&>svg]:size-3.5 [&>svg]:text-muted-foreground",
          defaultClassNames.caption_label
        ),
        month_grid: cn("w-full border-collapse", defaultClassNames.month_grid),
        weekdays: cn("flex", defaultClassNames.weekdays),
        weekday: cn(
          "flex-1 rounded-(--radius-md) text-[0.8rem] font-normal text-muted-foreground select-none",
        ...
        range_start: cn(
          "relative isolate z-0 rounded-l-(--radius-md) bg-muted after:absolute after:inset-y-0 after:right-0 after:w-4 after:bg-muted",
